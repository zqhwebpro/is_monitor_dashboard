    ...
    $.getJSON('http://localhost:8080/api/monitoring/gaTopBottom', function(
        ...
        json[0].top10.forEach((top10, index) => {
            ...
            $('#top-10').append(
                ...
                <div class="flex bar-background">
                    <span class="flex-a green"><span class="text-sm">Revenue</span><span class="siteName">${top10.site}</span></span>
        ...
        json[0].bottom10.forEach((bottom10, index) => {
            ...
            $('#bottom-10').append(
                `
                <div class="flex bar-background">
                    <span class="flex-a red"><span class="text-sm">Revenue</span><span class="siteName">${bottom10.site}</span></span>
                    <span class="flex-b"><span class="twoWeeks">
